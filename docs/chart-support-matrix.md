...
| S-STYLE-004 | `seriesLine`, `dropLine`, `hiLoLine`, `upBar`, `downBar` | Partial | Direct formatting wins; the effective numeric/linked role supplies omitted solid fill/line properties. Decoration lines retain visibility, color, width, preset dash, cap, and join. Structured decoration outlines, custom dash/compound geometry, and general linked effects remain unpainted; up/down bar mark effects are supported. |
| S-STYLE-005 | `errorBar`, `leaderLine` | Partial | Direct line paint and `noFill` win; effective numeric/linked solid color, width, preset dash, and visibility are consumed in shared 2-D and optional 3-D paths. Structured outlines, custom dash/compound geometry, and effects remain unpainted. |
| S-STYLE-006 | `trendline` | Partial | Direct trendline paint and `noFill` win; effective numeric/linked solid color, width, preset dash, and visibility are consumed by plot and legend. Structured outlines, custom dash/compound geometry, and effects remain unpainted. |
| S-STYLE-007 | `dataTable` | Partial | Effective numeric/linked solid line supplies omitted grid color, width, preset dash, and `noFill`; direct table formatting remains authoritative. Structured grid outlines, custom dash/compound geometry, and effects remain unpainted. |
| S-STYLE-008 | `gridlineMajor`, `gridlineMinor` | Partial | Effective numeric/linked solid line fallback applies to enabled primary and secondary gridlines; direct paint and `noFill` retain precedence. Structured outlines, custom dash/compound geometry, and effects remain unpainted. |
